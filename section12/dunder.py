...
utilizando Double Under para não gerar conflitos com os nomes desses elementos na programação.
...
o Python atribuirá à variável __name__ o valor __main__ indicando que este é o módulo
